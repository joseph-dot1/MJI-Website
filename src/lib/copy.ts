/**
 * All page copy, verbatim from MJI_Landing_Page_Copy_FINAL.md.
 * Do not edit wording here without flagging it against the source doc.
 */
...
export const problem = {
  ...
  scenes: [
    {
      lead: "The final-year student",
      rest: " with a first-class CGPA and no idea what leadership means once the title is gone.",
    },
    {
      lead: "The ambitious 24-year-old",
      rest: " grinding at a first job, with no mentor to say what actually matters.",
    },
    {
      lead: "The reader who wants to grow",
      rest: " but has no community holding them accountable to finish what they start.",
    },
  ],
  closerA: "Information is free everywhere. ",
  closerB: "Formation isn’t.",
  closerC: "That’s the gap MJI exists to close.",
};
...
export const outcomes = {
  ...
  headline: "If it doesn’t build you, we don’t do it.",
  intro: "Every single MJI activity is required to produce at least one of six outcomes:",
  list: [
    "Purpose Discovery",
...
export const howToJoin = {
  eyebrow: "Your Plan",
  headline: "Five steps from curious to committed.",
  steps: [
    { name: "Register", body: "Complete the online registration form.", meta: "(2 minutes, free)" },
    { name: "Get accepted", body: "Join the community once your application is reviewed.", meta: "" },
    { name: "Onboard", body: "Go through orientation so you know exactly how MJI works.", meta: "" },
...
export const values = {
  ...
  headline: "Eight values. No exceptions.",
  items: [
    { name: "Purpose", line: "Every activity answers “why,” not just “what.”" },
    { name: "Integrity", line: "We say what we mean and do what we say." },
    { name: "Growth", line: "Comfort is not the goal. Capacity is." },
    { name: "Leadership", line: "We develop people who can be trusted with responsibility." },
    { name: "Excellence", line: "Good enough isn’t." },
    { name: "Service", line: "Leadership that doesn’t serve isn’t leadership." },
    { name: "Community", line: "No one transforms society alone." },
    { name: "Stewardship", line: "What’s entrusted to us is not ours to waste." },
  ],
};

export const whoItsFor = {
  headline: "Built for the people carrying the next decade.",
  primaryLabel: "Primary",
  primary:
    "Teenagers (11–19) and young adults (20–30) who want direction, discipline, and a track record of leadership before the world hands them one.",
  alsoLabel: "Also welcome",
  also: "Mentors, volunteers, professionals, and strategic partners investing in Nigeria’s next generation.",
};

export const socialProof = {
  eyebrow: "Already Moving",
  stats: [
    { value: 650, suffix: "+", label: "Book Club members reading weekly", countUp: true },
    { value: 5, suffix: "", label: "Chapters across Nigeria", countUp: false },
    { value: 250, suffix: "+", label: "Lives reached through outreach", countUp: true },
    { value: 6, suffix: "", label: "Communities & facilities served", countUp: false },
  ],
  verification:
...
export const partners = {
  ...
  cta: "Partner With MJI",
};

export const involvement = {
  headline: "There’s a place for you, whoever you are.",
  rows: [
    {
...
export const faq = {
  ...
  items: [
    ...
    },
    {
      ...
      a: "Chapters run weekly activities across the three branches. Weekly reading sessions take about an hour; everything else scales with your availability. Consistency matters more than volume.",
    },
    {
